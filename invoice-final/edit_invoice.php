		    	...
		    	<div class="row">
			      	...
			      	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-left">
						...
						<div class="form-group">
							<input value="<?php echo $invoiceValues['order_receiver_vehicle_brand']; ?>" type="text" class="form-control" name="vehicleBrand" id="vehicleBrand" placeholder="Vehicle Brand" autocomplete="off">
						</div>
						<div class="form-group">
							<textarea class="form-control" rows="3" name="vehicleModel" id="vehicleModel" placeholder="Vehicle Model"><?php echo $invoiceValues['order_receiver_vehicle_model']; ?></textarea>
						</div>
					</div>
